...
import nil.test.uncertaintycalc.math.expr.ConstNumericExpr;
...
public class Sqrt extends MathFunction {
    ...
    public BigDecimal call(RuntimeEnv ctx, BigDecimal... argv) throws MathException {
        ...
        return BigDecimal.valueOf(Math.sqrt(argv[0].doubleValue()));
    }
    ...
    public MathFunction pdiff(int index) throws TargetNotDifferentiableException {
        ...
        return new ExpressionFunction(new MulChainExpr().multiply(new ConstNumericExpr("0.5")).multiply(new StaticFunctionCall(new Pow(), new NumericVariable("x"), new ConstNumericExpr("-0.5"))), "sqrt'", "x");
    }
